...
TEST(TopologyTest, aggregatetEmergencySpecifications) {
  ...
  ASSERT_EQ(edge_1.emergency_stream_ids,stream_ids_e31);
  ...
  ASSERT_EQ(edge_2.emergency_stream_ids,stream_ids_e10);
  ...
  ASSERT_EQ(edge_3.emergency_stream_ids,stream_ids_e02);
  ...
  ASSERT_EQ(edge_4.emergency_stream_ids,stream_ids_e20);
  ...
  ASSERT_EQ(edge_5.emergency_stream_ids,stream_ids_e01);
  ...
  ASSERT_EQ(edge_6.emergency_stream_ids,stream_ids_e13);
}
