...
protected:
  void SetUp() override {
    string devices[] = {"T_1", "T_2", "B_1", "B_2", "B_3", "L_1", "L_2"};
    vector<NetworkDeviceProperty> device_properties;
    unique_id = 0;
    for (int i = 0; i < 7; i++)
...
// TEST_F(DGMTest, TabuSearchMakespan) {
