...
namespace tsndgm
{
    ...
    void CriticalPath::compute_longest_paths(bool reverse)
    {
        ...
        else
        {
            dgm_traversal(
                transmission_graph,
                visitor(longest_path_visitor(transmission_graph)).root_vertex(prop.src));
        }
    }
    ...
    Delay CriticalPath::get_fixed_lateness(MessageStreamHandle ms, Edge listener)
    {
        ...
        Delay lateness =
            ...
            transmission_graph[boost::edge(v_listener, prop.sink, transmission_graph).first]
            .weight -
            stream.e2e_latency;
        return lateness;
    }
    ...
    CriticalPath::Result CriticalPath::weighted_fixed_lateness_path(Delay min)
    {
        ...
        return {
            static_cast<Delay>(lround(max_lateness.first * 100)),
            max_lateness.second
        };
    }
