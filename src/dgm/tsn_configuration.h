...
namespace tsndgm
{
    ...
    {
    public:
        TSNConfiguration(transmission_graph_t &transmission_graph, const NetworkTopology &topology) :
    ...
    {
    public:
        tsn_configuration_visitor(transmission_graph_t &transmission_graph, const NetworkTopology &topology,
                                  GCLConfiguration &gcl_config, PSFPConfiguration &psfp_config) :
            longest_path_visitor(transmission_graph), topology(topology), gcl_config(gcl_config),
            psfp_config(psfp_config){};
